//
//  ComputerStudiesTextbooks.swift
//  JambPrep
//
...
struct ComputerStudiesTextbooks: View {
    var body: some View {
            ZStack {
                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    Text("10. Henderson, P. (1987, February), Modern Introductory Computer Science.")
...
struct ComputerStudiesTextbooks_Previews: PreviewProvider {
